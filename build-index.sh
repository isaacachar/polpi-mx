...
<body>
    ...
    <div class="filters">
        <div class="filters-container">
            ...
            <span class="results-count" id="resultsCount">83 resultados en CDMX</span>
        </div>
    </div>
                ...
                <div class="listing-card" data-id="${listing.id}" onclick="highlightListing('${listing.id}')">
                    <div class="listing-image">
                        ${listing.images && listing.images[0] 
                            ? `<img src="${listing.images[0]}" alt="${listing.title}" onerror="this.parentElement.innerHTML='<span class=\\'placeholder-icon\\'>🏠</span>'">`
